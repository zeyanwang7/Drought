...
output_file = r"C:\Users\wangrui\Desktop\作物单产2001-2022\冬春小麦去趋势分离单产结果_二次拟合.xlsx"

# 图片输出总目录
plot_root = r"C:\Users\wangrui\Desktop\作物单产2001-2022\二次拟合图片"
...
def main():
    ...
    with pd.ExcelWriter(output_file, engine="openpyxl") as writer:
        for sheet_name in target_sheets:
            ...
            short_name = "冬小麦" if "冬小麦" in sheet_name else "春小麦"
