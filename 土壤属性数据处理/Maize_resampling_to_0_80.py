...
# 1. 路径设置
# =============================================================================
INPUT_DIR = r"E:\data\SoilData\Maize_0p1deg_Masked_Filled"
OUTPUT_DIR = r"E:\data\SoilData\Maize_0p1deg_Masked_Filled_Resampled"
os.makedirs(OUTPUT_DIR, exist_ok=True)

CHECK_EXCEL = os.path.join(OUTPUT_DIR, "Maize_Soil_Resampled_CheckTable.xlsx")

# 只处理插补后的春夏玉米文件
TARGET_FILES = None
# TARGET_FILES = [
#     r"E:\data\SoilData\Maize_0p1deg_Masked_Filled\TH1500_Spring_Maize_0p1deg_masked_filled.nc",
#     r"E:\data\SoilData\Maize_0p1deg_Masked_Filled\TH33_Spring_Maize_0p1deg_masked_filled.nc",
#     r"E:\data\SoilData\Maize_0p1deg_Masked_Filled\TH1500_Summer_Maize_0p1deg_masked_filled.nc",
#     r"E:\data\SoilData\Maize_0p1deg_Masked_Filled\TH33_Summer_Maize_0p1deg_masked_filled.nc",
# ]
    ...
    for nc_path in nc_files:
        ...
        try:
            ...
            new_ds[var_name].attrs["note"] = (
                "Resampling was performed on filled crop-masked maize soil files. "
