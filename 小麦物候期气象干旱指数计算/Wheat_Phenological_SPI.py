...
# 1. 基本参数设置
# =========================================================
spi_base_dir = r"E:\data\SPI\Wheat"
pheno_base_dir = r"E:\数据集\重采样后物候期\小麦\0.1度_修复版"
output_base_dir = r"E:\data\SPI\Wheat\Pheno_Stage_Mean"
...
# =========================================================
def calc_stage_mean_by_year(spi_da, gr_da, he_da, ma_da):
    # 物候有效掩膜
    valid_pheno = (
...
def run_single_task(crop, scale):
    ...
    # 计算
    ds_out = calc_stage_mean_by_year(spi_da, gr_da, he_da, ma_da)
...
if __name__ == "__main__":
    print("=" * 120)
    print("开始批量计算春冬小麦 1/3/6/9/12 个月 SPI 的两个物候阶段平均值（2002-2022）")
    print("=" * 120)
