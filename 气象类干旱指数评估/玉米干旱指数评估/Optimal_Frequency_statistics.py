...
# 1. 路径设置
# =============================================================================
input_excel = r"E:\data\Province_Stage_Index_Mean\最终筛选结果\春夏玉米_全国加权平均R2最优指标_按多年平均产量权重.xlsx"
input_sheet = "R2值_权重合并明细"

output_dir = r"E:\data\Province_Stage_Index_Mean\最终筛选结果\春夏玉米_稳定性_解释力散点图"
os.makedirs(output_dir, exist_ok=True)

output_png = os.path.join(output_dir, "春夏玉米_稳定性_解释力散点图.png")
output_excel = os.path.join(output_dir, "春夏玉米_稳定性_解释力散点图_统计结果.xlsx")

# =============================================================================
# 2. 参数设置
# =============================================================================
INDEX_ORDER = ["SPI", "SPEI", "SPET", "SVPD", "SEDI"]
CROP_ORDER = ["Spring_Maize", "Summer_Maize"]
STAGE_ORDER = ["阶段1", "阶段2"]
