...
# --- 1. 路径设置 ---
spei_path = r'E:\data\计算结果\Provinces_Cotton_SPEI_Steps.csv'
...
df_res.to_csv(os.path.join(output_dir, 'Cotton_SPEI_Yield_Correlation.csv'), index=False, encoding='utf-8-sig')
...
for prov in common_provinces:
    ...
    plt.title(f'{prov}省 棉花产量对全年生育期 SPEI 的敏感性分析', fontsize=14)
