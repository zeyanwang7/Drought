...
if not os.path.exists(spei_corr_path):
    ...
    ax.set_title('Evolution of Yield Sensitivity to SPEI for Rice (Mar-Dec)', fontsize=16, fontweight='bold', pad=20)
    ...
    # --- 6. Export ---
    save_path = os.path.join(output_dir, 'Rice_Drought_Sensitivity_Proportion_EN_Final.png')
