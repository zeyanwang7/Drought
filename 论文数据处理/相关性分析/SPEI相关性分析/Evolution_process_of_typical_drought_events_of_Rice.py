...
# --- 1. 路径设置 ---
spei_path = r'E:\data\meteorologicaldata\SPEI\SPEI_30d_8dStep_Rice.nc'
shp_path = r'E:\数据集\中国_省\中国_省2.shp'
output_dir = r'E:\计算结果'
if not os.path.exists(output_dir):
    os.makedirs(output_dir)
output_filename = os.path.join(output_dir, '水稻典型干旱演变图_修正裁剪版.png')
...
spei_period = ds['SPEI_30d'].sel(time=slice('2011-06-15', '2011-10-15'))
...
plt.suptitle("水稻关键生育期 SPEI 时空演变 (2011年)", fontsize=26, y=0.98, fontweight='bold')
