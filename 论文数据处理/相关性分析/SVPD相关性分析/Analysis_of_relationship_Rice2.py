...
if not os.path.exists(svpd_corr_path):
    ...
    # --- 5. 美化与标签 ---
    ax.set_title('Evolution of Rice Yield Sensitivity to SVPD (Mar-Dec)', fontsize=16, fontweight='bold', pad=20)
    ...
    # --- 6. 导出 ---
    save_path = os.path.join(output_dir, 'Rice_SVPD_Sensitivity_Proportion_Final.png')
