...
# --- 参数设置 ---
input_dir = r'E:\data\全国1Km作物种植数据\玉米'
ref_year = 2019  # 基准年份
output_path = os.path.join(input_dir, 'Maize_Final_Presence5_2000_2019_Fixed.tif')
start_year = 2000
end_year = 2019
threshold = 5
def process_and_fix_black_rectangle():
    # 1. 获取基准文件元数据
    ref_file = os.path.join(input_dir, f"CHN_Maize_{ref_year}.tif")
    ...
    for year in range(start_year, end_year + 1):
        file_path = os.path.join(input_dir, f"CHN_Maize_{year}.tif")
